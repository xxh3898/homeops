...
final class PostgresqlNotificationTestDatabase implements AutoCloseable {
    private final String schema;
    private final DriverManagerDataSource adminDataSource;
    private final DriverManagerDataSource schemaDataSource;

    private PostgresqlNotificationTestDatabase() {
        schema = "notification_" + UUID.randomUUID().toString().replace("-", "");
    ...
    static PostgresqlNotificationTestDatabase create() {
        return new PostgresqlNotificationTestDatabase();
    }
