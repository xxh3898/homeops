...
final class PostgresqlContainerActionTestDatabase implements AutoCloseable {
    private final String schema;
    private final DriverManagerDataSource adminDataSource;
    private final DriverManagerDataSource schemaDataSource;

    private PostgresqlContainerActionTestDatabase() {
        schema = "container_action_" + UUID.randomUUID().toString().replace("-", "");
    ...
    static PostgresqlContainerActionTestDatabase create() {
        return new PostgresqlContainerActionTestDatabase();
    }
