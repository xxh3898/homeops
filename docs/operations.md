...
| HomeOps | 신뢰하는 reporter의 future deployment·backup lifecycle과, persisted exact-origin incident 중 명시적으로 opt-in한 service의 future transition | 각 source producer와 Phase 4 Discord delivery가 활성화된 이후 |
