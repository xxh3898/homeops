...
이 마일스톤에는 컨테이너 변경, 임의 명령, live/follow log stream, log 저장·검색·내보내기, 일반 네트워크 요청 endpoint가 없습니다. Discord 알림은 typed allowlist, explicit opt-in과 global kill switch 안에서만 동작하며 arbitrary webhook이나 optional email escalation은 제공하지 않습니다.
