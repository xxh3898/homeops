...
- `GET /api/v1/activity`: deployment, backup, incident, Agent와 container control audit의 범위 제한 projection, optional single `type` filter 및 first-page 기준 최대 1시간의 scope-bound HMAC cursor 제공
